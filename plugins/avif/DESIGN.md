...
maps, progressive preview rendering and layered/`a1lx` selection. ICC bytes remain available through
`IDecoder::iccProfile()` for a future CMS but are not forwarded through the PVD ABI. libavif rejects
