# This overlay port pins libavif 1.4.2#2 (see vcpkg.json in this directory) independently of the
# top-level vcpkg.json's "builtin-baseline". Moving the baseline does not update this port; bump
# version-semver/port-version here by hand (and re-verify SHA512 below) when a newer libavif is
# needed.
vcpkg_from_github(
    ...
    PATCHES
        ...
        merge-static-libs-clang-cl.patch
)
